...
namespace testdotnettwain
{
	...
	public class Form2 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.BtnScan.Text = System.Configuration.ConfigurationSettings.AppSettings["ScanButtonText"];
			...
			this.label2.Text = System.Configuration.ConfigurationSettings.AppSettings["BodyNoteLabel"];
			// 
			// label1
			// 
			...
			this.label1.Text = System.Configuration.ConfigurationSettings.AppSettings["HeaderNoteLabel"];
			// 
			// Form2
			// 
		...
		frmMain frmmain	=new frmMain(this.txtHeader.Text,this.txtNote.Text);
